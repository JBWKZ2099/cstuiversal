...
<head>
	<?php
		$view_name="Reparación de Lavadoras, Secadoras y Centros de Lavado | Inicio";
		$which = "home";
		$description = "Le ofrecemos la mejor alternativa en mantenimiento preventivo y correctivo de su lavadora y secadora, con refacciones originales y servicio certificado por las mejores marcas.";
	...
	<metadata class="sr-only" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:dc="http://purl.org/dc/elements/1.1/" >
		...
		<dc:subject>Reparación de Lavadoras, Secadoras y Centros de Lavado.</dc:subject>
...
<body>
	<?php $active="rep-lava"; include(/*$dir.*/"structure/navbar.php"); ?>
			...
			<div class="col-md-12 px-0">
				<div id="home-carousel" class="carousel slide full-carousel circle-indicators" data-ride="carousel" data-ride="0">
					<div class="carousel-inner">
						<div class="carousel-item active" style="background-image: url('assets/img/lavadoras/slidelavadoras.png')">
	...
	<section class="container-custom py-3 py-md-5">
		<div class="row justify-content-center">
			<div class="col-md-12 mb-3 text-center">
				<img class="img-fluid d-block m-auto" src="<?php Times::fileTime("assets/img/lavadoras/lavadorasicono.png") ?>" alt="reparacion_de_aires_acondicionados">
			</div>

			<div class="col-md-12 text-center">
				<h2 class="text-blue mb-3 mb-md-4">Reparación de Lavadoras y Secadoras</h2>
	...
	<section class="container-custom py-3 -py-md-5">
		<div class="row">
			<div class="col-md-12">
				...
				<p class="h4 normal-text text-justify text-md-center mb-3 mb-md-4">Le ofrecemos la mejor alternativa en mantenimiento preventivo y correctivo de su lavadora y secadora, con refacciones originales y servicio certificado por las mejores marcas.</p>
